...
apt-get install -y gstreamer1.0-vaapi gstreamer1.0-tools libvdpau1 libva1 libva-wayland1 gstreamer1.0-alsa gstreamer1.0-plugins-good gstreamer1.0-plugins-bad libdbus-1-dev alsa-utils
